...
public class ShortMessageStore
{
    ...
    public synchronized void writeToFile() {
        try {
            if (messages.size() != 0) {
                ...
                Object key;
                BufferedWriter fw = new BufferedWriter(new FileWriter(new File("msgs_" + System.currentTimeMillis() + ".csv")));
                fw.write("------------------------------------------------------------------------");
                fw.newLine();
                fw.write("| Msg Id   |Sender     |ServT|Source address |Dest address   |Message   ");
                fw.newLine();
                fw.write("------------------------------------------------------------------------");
                fw.newLine();
     ...
     * @return
     */
    private String makeMessage(Object key, ShortMessageValue sMV)
    {
        String messageId, systemId, serviceType, sourceAddr, destAddr, shortMessage;
