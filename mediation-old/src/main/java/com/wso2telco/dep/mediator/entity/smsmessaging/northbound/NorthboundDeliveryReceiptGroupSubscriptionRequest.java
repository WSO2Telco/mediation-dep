 ...
 */
public class NorthboundDeliveryReceiptGroupSubscriptionRequest {

    /** The delivery receipt subscription. */
    private DeliveryReceiptGroupSubscription deliveryReceiptSubscription;
     ...
     */
    public DeliveryReceiptGroupSubscription getDeliveryReceiptSubscription() {
     ...
     */
    public void setDeliveryReceiptSubscription(DeliveryReceiptGroupSubscription deliveryReceiptSubscription) {
